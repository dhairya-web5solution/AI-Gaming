...
export default function About() {
  const teamMembers = [
    ...
    },
    {
      ...
      image: "https://raw.githubusercontent.com/dhairya-web5solution/AI-Gaming/refs/heads/main/team/sarvesh.jpg",
                ...
                <div className="relative mb-6">
                  <div className="w-32 h-32 mx-auto rounded-full overflow-hidden border-4 border-transparent bg-gradient-to-br from-purple-500 to-blue-500 p-1">
                    <div className="w-full h-full rounded-full overflow-hidden bg-gray-800 flex items-center justify-center">
                      ...
                      <User className="w-16 h-16 text-gray-500" style={{ display: 'none' }} />
                    </div>
                  </div>
